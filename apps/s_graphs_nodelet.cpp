...
private:
      ...
      for(const auto& room_data : room_data_msg.rooms) {
        ...
        if(room_data.x_planes.size() == 2 && room_data.y_planes.size() == 2) {
          ...
          if(min_dist_room_y_corr < 0.5 && min_dist_room_x_corr < 0.5) {
            ...
            map_room_from_existing_x_corridor(room_data, matched_x_corridor);
            ...
            map_room_from_existing_y_corridor(room_data, matched_y_corridor);
          }
        ...
        // x corridor
          ...
          factor_corridors(PlaneUtils::plane_class::X_VERT_PLANE, x_plane1_data, x_plane2_data);
        }
        // y corridor
          ...
          factor_corridors(PlaneUtils::plane_class::Y_VERT_PLANE, y_plane1_data, y_plane2_data);
        }
      }
   ...
   *
   */
  void map_room_from_existing_corridors(const s_graphs::RoomData& det_room_data, const s_graphs::Corridors& matched_x_corridor, const s_graphs::Corridors& matched_y_corridor) {
   ...
   *
   */
  void map_room_from_existing_x_corridor(const s_graphs::RoomData& det_room_data, const s_graphs::Corridors& matched_x_corridor) {
    g2o::VertexRoomXYLB* room_node;
    std::pair<int, int> room_data_association;
   ...
   *
   */
  void map_room_from_existing_y_corridor(const s_graphs::RoomData& det_room_data, const s_graphs::Corridors& matched_y_corridor) {
    g2o::VertexRoomXYLB* room_node;
    std::pair<int, int> room_data_association;
      ...
      if(found_current_room != rooms_vec.end()) {
        ...
        for(const auto& connected_neighbour_id : (*found_current_room).connected_neighbour_ids) {
          ...
          if(found_current_room_neighbour != rooms_vec.end()) {
            ...
            factor_room_room_constraints((*found_current_room), (*found_current_room_neighbour), room_room_meas);
          } else {
            ...
            if(found_current_x_corridor_neighbour != x_corridors.end()) {
              ...
              factor_room_x_corridor_constraints((*found_current_room), (*found_current_x_corridor_neighbour), room_x_corr_meas);
            } else {
              ...
              if(found_current_y_corridor_neighbour != y_corridors.end()) {
                ...
                factor_room_y_corridor_constraints((*found_current_room), (*found_current_y_corridor_neighbour), room_y_corr_meas);
              }
            }
          }
        }
        ...
        if(found_current_x_corridor != x_corridors.end()) {
          ...
          for(const auto& connected_neighbour_id : (*found_current_x_corridor).connected_neighbour_ids) {
            ...
            if(found_current_room_neighbour != rooms_vec.end()) {
              ...
              factor_x_corridor_room_constraints((*found_current_x_corridor), (*found_current_room_neighbour), x_corr_room_meas);
            } else {
              auto found_current_x_corridor_neighbour = std::find_if(x_corridors.begin(), x_corridors.end(), boost::bind(&Corridors::connected_id, _1) == connected_neighbour_id);
              if(found_current_x_corridor_neighbour != x_corridors.end()) {
                double x_corr_x_corr_meas = x_corridor_x_corridor_measurement(room_data, (*found_detected_neighbour));
                factor_x_corridor_x_corridor_constraints((*found_current_x_corridor), (*found_current_x_corridor_neighbour), x_corr_x_corr_meas);
              } else {
                auto found_current_y_corridor_neighbour = std::find_if(y_corridors.begin(), y_corridors.end(), boost::bind(&Corridors::connected_id, _1) == connected_neighbour_id);
                if(found_current_y_corridor_neighbour != y_corridors.end()) {
          ...
          if(found_current_y_corridor != y_corridors.end()) {
            ...
            for(const auto& connected_neighbour_id : (*found_current_y_corridor).connected_neighbour_ids) {
              ...
              if(found_current_room_neighbour != rooms_vec.end()) {
                ...
                factor_y_corridor_room_constraints((*found_current_y_corridor), (*found_current_room_neighbour), y_corr_room_meas);
              } else {
                auto found_current_x_corridor_neighbour = std::find_if(x_corridors.begin(), x_corridors.end(), boost::bind(&Corridors::connected_id, _1) == connected_neighbour_id);
                if(found_current_x_corridor_neighbour != x_corridors.end()) {
                  ...
                  if(found_current_y_corridor_neighbour != y_corridors.end()) {
                    ...
                    factor_y_corridor_y_corridor_constraints((*found_current_y_corridor), (*found_current_y_corridor_neighbour), y_corr_y_corr_meas);
                  }
                }
              }
            }
   ...
   *
   */
  void factor_room_room_constraints(s_graphs::Rooms& room1, const s_graphs::Rooms& room2, Eigen::Vector2d room_room_meas) {
   ...
   *
   */
  void factor_room_x_corridor_constraints(s_graphs::Rooms& room, const s_graphs::Corridors& x_corridor, double room_x_corr_meas) {
    bool neighbour_exists = false;
   ...
   *
   */
  void factor_room_y_corridor_constraints(s_graphs::Rooms& room, const s_graphs::Corridors& y_corridor, double room_y_corr_meas) {
    bool neighbour_exists = false;
    for(const auto& room_neighbour_id : room.neighbour_ids) {
  ...
  void factor_x_corridor_room_constraints(s_graphs::Corridors& x_corridor, const s_graphs::Rooms& room, double x_corr_room_meas) {
    bool neighbour_exists = false;
  ...
  void factor_x_corridor_x_corridor_constraints(s_graphs::Corridors& x_corridor1, const s_graphs::Corridors& x_corridor2, double x_corr_x_corr_meas) {
    bool neighbour_exists = false;
  ...
  void factor_y_corridor_room_constraints(s_graphs::Corridors& y_corridor, const s_graphs::Rooms& room, double y_corr_room_meas) {
    bool neighbour_exists = false;
  ...
  void factor_y_corridor_y_corridor_constraints(s_graphs::Corridors& y_corridor1, const s_graphs::Corridors& y_corridor2, double y_corr_y_corr_meas) {
    bool neighbour_exists = false;
  ...
  void lookup_corridors(std::vector<plane_data_list> x_det_corridor_candidates, std::vector<plane_data_list> y_det_corridor_candidates) {
    ...
    if(x_corridor_refined.size() == 2) factor_corridors(PlaneUtils::plane_class::X_VERT_PLANE, x_corridor_refined[0], x_corridor_refined[1]);

    std::vector<plane_data_list> y_corridor_refined = refine_corridors(y_corridor);
    if(y_corridor_refined.size() == 2) factor_corridors(PlaneUtils::plane_class::Y_VERT_PLANE, y_corridor_refined[0], y_corridor_refined[1]);
  }
  ...
  void factor_corridors(int plane_type, plane_data_list corr_plane1_pair, plane_data_list corr_plane2_pair) {
    ...
    if(plane_type == PlaneUtils::plane_class::X_VERT_PLANE) {
      ...
      if((x_corridors.empty() || corr_data_association.first == -1)) {
        ...
        det_corridor.keyframe_trans = corr_plane1_pair.plane_centroid;
        det_corridor.node = corr_node;
        ...
        if((*found_plane1).id == (*found_mapped_plane1).id)
          meas_plane1 = corridor_measurement(plane_type, corr_pose(0), found_mapped_plane1_coeffs);
        ...
        if((*found_plane2).id == (*found_mapped_plane1).id)
          meas_plane2 = corridor_measurement(plane_type, corr_pose(0), found_mapped_plane1_coeffs);
    ...
    if(plane_type == PlaneUtils::plane_class::Y_VERT_PLANE) {
      ...
      if((y_corridors.empty() || corr_data_association.first == -1)) {
        ...
        meas_plane1 = corridor_measurement(plane_type, corr_pose(1), corr_plane1_pair.plane_unflipped.coeffs());
        ...
        bool found_new_plane = false;
        if((*found_plane1).id == (*found_mapped_plane1).id)
          meas_plane1 = corridor_measurement(plane_type, corr_pose(1), found_mapped_plane1_coeffs);
        else if((*found_plane1).id == (*found_mapped_plane2).id)
        ...
        if((*found_plane2).id == (*found_mapped_plane1).id)
          meas_plane2 = corridor_measurement(plane_type, corr_pose(1), found_mapped_plane1_coeffs);
        else if((*found_plane2).id == (*found_mapped_plane2).id)
    ...
    for(auto it = dupl_x_vert_planes.begin(); it != dupl_x_vert_planes.end(); ++it) {
      ...
      for(auto edge_itr = edges.begin(); edge_itr != edges.end(); ++edge_itr) {
        ...
        if(edge_corridor_xplane) {
          ...
          plane_utils->correct_plane_d(PlaneUtils::plane_class::X_VERT_PLANE, found_mapped_plane1_coeffs);
          double meas_plane1 = corridor_measurement(PlaneUtils::plane_class::X_VERT_PLANE, corridor_node->estimate(), found_mapped_plane1_coeffs);
          Eigen::Matrix<double, 1, 1> information_corridor_plane(corridor_information);
        ...
        if(edge_room_xplane) {
          ...
          plane_utils->correct_plane_d(PlaneUtils::plane_class::X_VERT_PLANE, found_mapped_x_plane1_coeffs);
          double x_plane1_meas = room_measurement(PlaneUtils::plane_class::X_VERT_PLANE, room_node->estimate(), found_mapped_x_plane1_coeffs);
          Eigen::Matrix<double, 1, 1> information_room_plane(room_information);
    ...
    for(auto it = dupl_y_vert_planes.begin(); it != dupl_y_vert_planes.end(); ++it) {
      ...
      for(auto edge_itr = edges.begin(); edge_itr != edges.end(); ++edge_itr) {
        ...
        if(edge_corridor_yplane) {
          ...
          Eigen::Vector4d found_mapped_plane1_coeffs = (*it).second.plane_node->estimate().coeffs();
          plane_utils->correct_plane_d(PlaneUtils::plane_class::Y_VERT_PLANE, found_mapped_plane1_coeffs);
          double meas_plane1 = corridor_measurement(PlaneUtils::plane_class::Y_VERT_PLANE, corridor_node->estimate(), found_mapped_plane1_coeffs);
          Eigen::Matrix<double, 1, 1> information_corridor_plane(corridor_information);
        ...
        if(edge_room_yplane) {
          ...
          plane_utils->correct_plane_d(PlaneUtils::plane_class::Y_VERT_PLANE, found_mapped_y_plane1_coeffs);
          double y_plane1_meas = room_measurement(PlaneUtils::plane_class::Y_VERT_PLANE, room_node->estimate(), found_mapped_y_plane1_coeffs);
          Eigen::Matrix<double, 1, 1> information_room_plane(room_information);
