...
public:
   ...
   * @param rooms_vec
   */
  void detect_room_neighbours(std::unique_ptr<GraphSLAM>& graph_slam, const s_graphs::RoomsData& room_msg, std::vector<Infinite_rooms>& x_corridors, std::vector<Infinite_rooms>& y_corridors, std::vector<Rooms>& rooms_vec);
   ...
   * @param rooms_vec
   */
  void factor_room_neighbours(std::unique_ptr<GraphSLAM>& graph_slam, const s_graphs::RoomsData& room_msg, std::vector<Infinite_rooms>& x_corridors, std::vector<Infinite_rooms>& y_corridors, std::vector<Rooms>& rooms_vec);
...
private:
   ...
   */
  void factor_room_x_corridor_constraints(std::unique_ptr<GraphSLAM>& graph_slam, s_graphs::Rooms& room, const s_graphs::Infinite_rooms& x_corridor, double room_x_corr_meas);
   ...
   */
  void factor_room_y_corridor_constraints(std::unique_ptr<GraphSLAM>& graph_slam, s_graphs::Rooms& room, const s_graphs::Infinite_rooms& y_corridor, double room_y_corr_meas);
   ...
   */
  void factor_x_corridor_room_constraints(std::unique_ptr<GraphSLAM>& graph_slam, s_graphs::Infinite_rooms& x_corridor, const s_graphs::Rooms& room, double x_corr_room_meas);
   ...
   */
  void factor_x_corridor_x_corridor_constraints(std::unique_ptr<GraphSLAM>& graph_slam, s_graphs::Infinite_rooms& x_corridor1, const s_graphs::Infinite_rooms& x_corridor2, double x_corr_x_corr_meas);
   ...
   * @param y_corridor
   */
  void factor_x_corridor_y_corridor_constraints(std::unique_ptr<GraphSLAM>& graph_slam, s_graphs::Infinite_rooms& x_corridor, const s_graphs::Infinite_rooms& y_corridor);
   ...
   */
  void factor_y_corridor_room_constraints(std::unique_ptr<GraphSLAM>& graph_slam, s_graphs::Infinite_rooms& y_corridor, const s_graphs::Rooms& room, double y_corr_room_meas);
   ...
   * @param x_corridor
   */
  void factor_y_corridor_x_corridor_constraints(std::unique_ptr<GraphSLAM>& graph_slam, s_graphs::Infinite_rooms& y_corridor, const s_graphs::Infinite_rooms& x_corridor);
   ...
   */
  void factor_y_corridor_y_corridor_constraints(std::unique_ptr<GraphSLAM>& graph_slam, s_graphs::Infinite_rooms& y_corridor1, const s_graphs::Infinite_rooms& y_corridor2, double y_corr_y_corr_meas);
};
